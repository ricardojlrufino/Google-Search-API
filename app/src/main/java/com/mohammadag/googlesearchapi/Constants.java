...
public class Constants {
	...
	public static final String KEY_DELAY_BROADCASTS = "delay_broadcasts";
	public static final String KEY_INTENT_TO_QUEUE = "intent_to_queue";
	public static final String KEY_PREVENT_DUPLICATES = "prevent_duplicates";

	public static final String INTENT_QUEUE_INTENT = "com.mohammadag.googlesearchapi.QUEUE_INTENT";
